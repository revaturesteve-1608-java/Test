package com.revpage.service.impl;
...
import com.revpage.service.Crypt;
...
public class CryptImpl implements Crypt{
	...
	/**
	 * Encrypt the string by the day of the month
	 * 
	 * @param target The string you want encrypted.
	 * @return
	 */
	private String saltTarget(String target){
		...
		//making sure single digit still have two number
		if(day < 10){
			salt = "0" + salt;
		}
	
		//add the random string to the target
		switch(day){
	...
	/**
	 * return the key string base on the day
	 * @param target The string you want encrypted.
	 * @return the key
	 */
	private String[] bindKeys(String target){
		...
		//base on the day since first two letter is the day
		switch(temp){
			case  1:
	...
	/**
	 * Change the character by the position of the character
	 * @param alpha1
	 * @param alpha2
	 * @param letter
	 * @param keyIndex
	...
	/**
	 * Change each character to a string
	 * @param c
	 * @return
	 */
